            ...
            <div class="donate-grid">
                <div class="donate-info">
                    ...
                    <div class="donation-badges">
                        <img src="<?php echo stcc_image_url('global-giving-badge.png'); ?>" alt="Global Giving Certified Organization">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="ways-grid">
                <div class="way-card">
                    ...
                    <a href="<?php echo home_url('/volunteer/'); ?>" class="btn btn-outline">Learn More</a>
                </div>
                <div class="way-card">
                    <i class="fas fa-graduation-cap"></i>
                    <h3>Intern</h3>
                    <p>Gain hands-on experience in marine conservation through our internship program.</p>
                    <a href="<?php echo home_url('/internships/'); ?>" class="btn btn-outline">Learn More</a>
                </div>
                <div class="way-card">
