...
// Enqueue the intern form script
wp_enqueue_script('stcc-intern-form', get_template_directory_uri() . '/js/intern-form.js', ['stcc-main'], STCC_VERSION, true);
?>
        ...
        <div class="container">
            ...
            <div class="intern-gallery">
                <div class="intern-gallery-item">
                    <img src="<?php echo stcc_image_url('team/interns/interns.jpeg'); ?>" alt="STCC Interns">
                </div>
                <div class="intern-gallery-item">
                    <img src="<?php echo stcc_image_url('team/interns/WhatsApp Image 2026-01-31 at 08.01.33.jpeg'); ?>" alt="STCC Intern in the field">
                </div>
                <div class="intern-gallery-item">
                    <img src="<?php echo stcc_image_url('team/interns/WhatsApp Image 2026-01-31 at 08.01.35.jpeg'); ?>" alt="STCC Intern working with sea turtles">
                </div>
                <div class="intern-gallery-item">
                    <img src="<?php echo stcc_image_url('team/interns/WhatsApp Image 2026-01-31 at 08.03.23.jpeg'); ?>" alt="STCC Intern on patrol">
                </div>
                <div class="intern-gallery-item">
                    <img src="<?php echo stcc_image_url('team/interns/fs2026-01-31 at 08.03.23.jpeg'); ?>" alt="STCC Intern fieldwork">
                </div>
            </div>
        </div>
    </section>
