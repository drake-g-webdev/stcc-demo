...
?>
    ...
    <!-- Scientific Committee - Featured -->
    <section class="content-section bg-light">
        <div class="container">
            <div class="committee-featured">
                <div class="committee-featured-header">
                    <h2>Scientific Committee</h2>
                </div>
                <div class="committee-featured-content">
                    <div class="committee-lead-photo">
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <p>We're always looking for dedicated individuals to help lead and participate in our committees. Contact us to learn about current opportunities.</p>
